...
ET_MODEL_TAGS = PLATFORM_205_MODELS + PLATFORM_745_LV_MODELS + PLATFORM_745_HV_MODELS + PLATFORM_753_MODELS + (
    ...
    "80KETG10", "99K9KETG10", "100KETG10")  # G10 ultra-high power commercial models
...
# MPPT8: 8 MPPT inputs (ultra-high power commercial models)
MPPT8_MODELS = ("80KETG10", "99K9KETG10", "100KETG10")  # G10 series: 8 MPPT, 2 strings/MPPT
...
BAT_2_MODELS = ("25KET", "29K9ET",  # ET 25-30kW: 2 batteries, 3 MPPT
                "80KETG10", "99K9KETG10", "100KETG10")  # G10 80-100kW: 2 batteries, 8 MPPT
...
def is_8_mppt(inverter: Inverter) -> bool:
    """Check if inverter has 8 MPPT inputs (G10 ultra-high power commercial models)."""
    return any(model in inverter.serial_number for model in MPPT8_MODELS)
