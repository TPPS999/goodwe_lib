...
class ET(Inverter):
    ...
    __settings_arm_fw_19: tuple[Sensor, ...] = (
        ...
        Integer("eco_mode_1_param1", 47550, "Eco Mode Group 1 Parameter 1", "", Kind.BAT),
        Integer("eco_mode_1_param2", 47551, "Eco Mode Group 1 Parameter 2", "", Kind.BAT),
        Integer("eco_mode_1_param3", 47552, "Eco Mode Group 1 Parameter 3", "", Kind.BAT),
        EcoModeV2("eco_mode_2", 47553, "Eco Mode Group 2"),
        ByteH("eco_mode_2_switch", 47555, "Eco Mode Group 2 Switch"),
        Integer("eco_mode_2_param1", 47556, "Eco Mode Group 2 Parameter 1", "", Kind.BAT),
        Integer("eco_mode_2_param2", 47557, "Eco Mode Group 2 Parameter 2", "", Kind.BAT),
        Integer("eco_mode_2_param3", 47558, "Eco Mode Group 2 Parameter 3", "", Kind.BAT),
        EcoModeV2("eco_mode_3", 47559, "Eco Mode Group 3"),
        ByteH("eco_mode_3_switch", 47561, "Eco Mode Group 3 Switch"),
        Integer("eco_mode_3_param1", 47562, "Eco Mode Group 3 Parameter 1", "", Kind.BAT),
        Integer("eco_mode_3_param2", 47563, "Eco Mode Group 3 Parameter 2", "", Kind.BAT),
        Integer("eco_mode_3_param3", 47564, "Eco Mode Group 3 Parameter 3", "", Kind.BAT),
        EcoModeV2("eco_mode_4", 47565, "Eco Mode Group 4"),
        ByteH("eco_mode_4_switch", 47567, "Eco Mode Group 4 Switch"),
        Integer("eco_mode_4_param1", 47568, "Eco Mode Group 4 Parameter 1", "", Kind.BAT),
        Integer("eco_mode_4_param2", 47569, "Eco Mode Group 4 Parameter 2", "", Kind.BAT),
        Integer("eco_mode_4_param3", 47570, "Eco Mode Group 4 Parameter 3", "", Kind.BAT),
    ...
    __settings_arm_fw_22: tuple[Sensor, ...] = (
        ...
        EcoModeV2("eco_mode_5", 47571, "Eco Mode Group 5"),
        ByteH("eco_mode_5_switch", 47573, "Eco Mode Group 5 Switch"),
        Integer("eco_mode_5_param1", 47574, "Eco Mode Group 5 Parameter 1", "", Kind.BAT),
        Integer("eco_mode_5_param2", 47575, "Eco Mode Group 5 Parameter 2", "", Kind.BAT),
        Integer("eco_mode_5_param3", 47576, "Eco Mode Group 5 Parameter 3", "", Kind.BAT),
        EcoModeV2("eco_mode_6", 47577, "Eco Mode Group 6"),
        ByteH("eco_mode_6_switch", 47579, "Eco Mode Group 6 Switch"),
        Integer("eco_mode_6_param1", 47580, "Eco Mode Group 6 Parameter 1", "", Kind.BAT),
        Integer("eco_mode_6_param2", 47581, "Eco Mode Group 6 Parameter 2", "", Kind.BAT),
        Integer("eco_mode_6_param3", 47582, "Eco Mode Group 6 Parameter 3", "", Kind.BAT),
        EcoModeV2("eco_mode_7", 47583, "Eco Mode Group 7"),
        ByteH("eco_mode_7_switch", 47585, "Eco Mode Group 7 Switch"),
        Integer("eco_mode_7_param1", 47586, "Eco Mode Group 7 Parameter 1", "", Kind.BAT),
        Integer("eco_mode_7_param2", 47587, "Eco Mode Group 7 Parameter 2", "", Kind.BAT),
        Integer("eco_mode_7_param3", 47588, "Eco Mode Group 7 Parameter 3", "", Kind.BAT),
        PeakShavingMode("peak_shaving_mode", 47589, "Peak Shaving Mode"),
        Integer("peak_shaving_param1", 47592, "Peak Shaving Parameter 1", "", Kind.BAT),
        Integer("peak_shaving_param2", 47593, "Peak Shaving Parameter 2", "", Kind.BAT),
        Integer("peak_shaving_param3", 47594, "Peak Shaving Parameter 3", "", Kind.BAT),
